...
#' @param rhoG PARAM_DESCRIPTION
#' @param rhoZ PARAM_DESCRIPTION
#' @param n_0 PARAM_DESCRIPTION
#' @param s_0 PARAM_DESCRIPTION
#' @param phi_0 PARAM_DESCRIPTION
#' @param var_0 PARAM_DESCRIPTION
#' @param varR_0 PARAM_DESCRIPTION
#' @param corRho_0 PARAM_DESCRIPTION
#' @param piG_0 PARAM_DESCRIPTION
#' @param piZ_0 PARAM_DESCRIPTION
#' @param chrPos_0 PARAM_DESCRIPTION
#' @param gParams PARAM_DESCRIPTION
#' @param nParams PARAM_DESCRIPTION
#' @param sParams PARAM_DESCRIPTION
#' @param pParams PARAM_DESCRIPTION
#' @param maxiter PARAM_DESCRIPTION, Default: 500
#' @param normalEstimateMethod PARAM_DESCRIPTION, Default: 'fixed'
...
#' }
#' @export
#' @rdname estimateClonalCNParamsMap
...
#' @param likInitG PARAM_DESCRIPTION
#' @param likInitZ PARAM_DESCRIPTION
...
#' @param maxiter PARAM_DESCRIPTION, Default: 500
#' @param miniter PARAM_DESCRIPTION, Default: 10
#' @param verbose PARAM_DESCRIPTION, Default: TRUE
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
#' @examples
...
#' @param c PARAM_DESCRIPTION
#' @param e PARAM_DESCRIPTION
#' @param alleleEmissionModel PARAM_DESCRIPTION
#' @param rt PARAM_DESCRIPTION
#' @param rn PARAM_DESCRIPTION
#' @param ct PARAM_DESCRIPTION
#' @param alphaN PARAM_DESCRIPTION
...
#' }
#' @export
#' @rdname clonalCNDerivativeNUpdateEqn
...
#' }
#' @export
#' @rdname clonalCNDerivativeSUpdateEqn
...
#' }
#' @export
#' @rdname clonalCNDerivativeVarExactUpdateEqn
...
#' }
#' @export
#' @rdname clonalCNDerivativeVarUpdateEqn
...
#' }
#' @export
#' @rdname clonalCNDerivativePloidyUpdateEqn
...
#' }
#' @export
#' @rdname estimateClonalMixWeightsParamMap
...
#' }
#' @export
#' @rdname estimateGenotypeMixWeightsParamMap
